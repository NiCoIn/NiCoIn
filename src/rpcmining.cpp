...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    GenerateNiCoIns(fGenerate, pwalletMain);
    return Value::null;
}
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "NiCoIn is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "NiCoIn is downloading blocks...");
