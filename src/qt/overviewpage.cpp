...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(NiCoInUnits::NCI)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = NiCoInUnits::formatWithUnit(unit, RoundAbsolute(amount, ROUND_TOWARDS_ZERO), true);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const mpq& balance, const mpq& unconfirmedBalance, const mpq& immatureBalance)
{
    ...
    ui->labelUnconfirmed->setText(NiCoInUnits::formatWithUnit(unit, RoundAbsolute(unconfirmedBalance, ROUND_TOWARDS_ZERO)));
    ui->labelImmature->setText(NiCoInUnits::formatWithUnit(unit, RoundAbsolute(immatureBalance, ROUND_TOWARDS_ZERO)));
...
void OverviewPage::setModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("NCI")
    updateDisplayUnit();
}
